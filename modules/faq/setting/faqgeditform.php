<?
    ...
    $rs=$faq->getFaqGroupById($_REQUEST['mid']);

	?>

	<span class="txtContentTitle"><?=_FAQ_SETTING; ?></span><br/><br/>

	<?=_FAQ_GROUP_EDIT_INSTRUCTION; ?><br/><br/>
    ...
    <input type="hidden" name="mid" value="<?=$rs->fields['fcgId']; ?>">
    ...
    <tr>
      ...
      <td><input type="text" name="fcgTitle" size="40" value="<?=$rs->fields['fcgTitle']; ?>"/></td>
    ...
    <tr>
      ...
      <td>
		...
		<textarea name="fcgDescription" cols="60" rows="10"><?=$rs->fields['fcgDescription']; ?></textarea>

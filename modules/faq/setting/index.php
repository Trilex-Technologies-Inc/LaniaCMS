<?
	...
	<?=_FAQ_SETTING_INSTRUCTION; ?><br/><br/>

	

	<img src="theme/<?=$cfg['theme']; ?>/images/new.gif" border="0" align="absmiddle"/>

	<a href="<?=$_SERVER['PHP_SELF']?>?modname=<?=$module_name?>&mf=faqnew" ><?=_NEW; ?></a>&nbsp;&nbsp;

    

	<img src="theme/<?=$cfg['theme']; ?>/images/view_choose.gif" border="0" align="absmiddle"/>

	<a href="<?=$_SERVER['PHP_SELF']?>?modname=<?=$module_name?>&mf=faqgroup" ><?=_GROUP_SETTING; ?></a>&nbsp;&nbsp;
